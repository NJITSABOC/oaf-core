...
public class ParentErrorReportOptions {
    ...
    public static <T extends Concept> ArrayList<JComponent> createParentErrorComponents(
        ...
        removeErroneousParentBtn.addActionListener((ae) -> {
            ErrorReportDialog.displayErroneousParentDialog(mainPanel, dataSource, parent);
        });
        ...
        removeRedundantParentBtn.addActionListener((ae) -> {
            ErrorReportDialog.displayRedundantParentErrorDialog(mainPanel, dataSource, parent);
        });
        ...
        otherParentErrorBtn.addActionListener((ae) -> {
            ErrorReportDialog.displayOtherParentErrorDialog(mainPanel, dataSource, parent);
        });
        ...
        replaceParentBtn.addActionListener((ae) -> {
            ErrorReportDialog.displayReplaceParentDialog(mainPanel, dataSource, parent);
        });
