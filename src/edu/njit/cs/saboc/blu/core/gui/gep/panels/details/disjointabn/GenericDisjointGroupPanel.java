...
public class GenericDisjointGroupPanel<CONCEPT_T, 
        ...
        CONFIG_T extends BLUDisjointConfiguration> extends SinglyRootedNodePanel<DISJOINTGROUP_T, CONCEPT_T, CONFIG_T> {
    ...
    public GenericDisjointGroupPanel(
            NodeDetailsPanel<DISJOINTGROUP_T, CONCEPT_T> disjointGroupDetailsPanel, 
            NodeHierarchyPanel<CONCEPT_T, DISJOINTGROUP_T, CONFIG_T> disjointGroupHierarchyPanel,
