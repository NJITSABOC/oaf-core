...
public abstract class TargetAbNTextConfiguration extends AbNTextConfiguration<TargetGroup> {
    ...
    public String getNodeHelpDescription(TargetGroup node) {
        ...
        String descriptionStr = ""
                ...
                + "that are targets of <propertyTypeName> relationships. The target group is named after "
                + "the lowest common ancestor that is not a target but has descendents that are targets.";
