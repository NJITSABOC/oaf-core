...
import edu.njit.cs.saboc.blu.core.gui.gep.panels.details.GroupInformationPanel;
...
public abstract class PAreaConceptHierarchyPanel<CONCEPT_T, PAREA_T extends GenericPArea, 
        HIERARCHY_T extends SingleRootedHierarchy<CONCEPT_T, HIERARCHY_T>> extends GroupInformationPanel<PAREA_T> {
