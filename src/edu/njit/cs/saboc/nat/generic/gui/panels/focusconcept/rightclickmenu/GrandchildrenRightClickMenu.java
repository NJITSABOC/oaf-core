 ...
 * @param <T>
 */
public class GrandchildrenRightClickMenu<T extends Concept> extends EntityRightClickMenuGenerator<T> {
    
    private final NATBrowserPanel<T> mainPanel;
    private final ConceptBrowserDataSource<T> dataSource;
    
    public GrandchildrenRightClickMenu(
    ...
    public ArrayList<JComponent> buildEmptyListRightClickMenu() {
        ...
        JMenuItem reportMissingParent = new JMenuItem("Add missing parent");
